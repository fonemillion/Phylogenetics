...
import winsound
from Utils.CherryDepend import getBasicTrivialLeaf, getBasicTemp3
...
for item in range(len(Tset)):
    ...
    L = Lset[item]
    print(T,L)
    folder_path = "../../Data/Temp3/" + str(L) + "L_" + str(T) + "T"
    ...
    while i < 20000:
        if i % 500 == 0:
            print(i)
        filename = "../../Data/Temp3/" + str(L) + "L_" + str(T) + "T/inst_" + str(i) + ".pickle"
